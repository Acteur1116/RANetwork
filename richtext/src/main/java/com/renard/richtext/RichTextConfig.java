...
import com.renard.richtext.callback.Callback;
import com.renard.richtext.callback.DrawableGetter;
import com.renard.richtext.callback.ImageFixCallback;
import com.renard.richtext.callback.ImageGetter;
import com.renard.richtext.callback.LinkFixCallback;
import com.renard.richtext.callback.OnImageClickListener;
import com.renard.richtext.callback.OnImageLongClickListener;
import com.renard.richtext.callback.OnUrlClickListener;
import com.renard.richtext.callback.OnUrlLongClickListener;
import com.renard.richtext.drawable.DrawableBorderHolder;
import com.renard.richtext.ig.DefaultImageDownloader;
import com.renard.richtext.ig.DefaultImageGetter;
import com.renard.richtext.ig.ImageDownloader;
...
public final class RichTextConfig {
    ...
    public static final String OK_HTTP_GLOBAL_ID = "com.renard.okhttpimagedownloader.OkHttpImageDownloader";
    ...
    public static final class RichTextConfigBuild {
         ...
         * @return RichTextConfigBuild
         */
        public RichText into(TextView textView, Context context) {
            // 检查图片下载器是否已设置
            if (imageGetter == null) {
