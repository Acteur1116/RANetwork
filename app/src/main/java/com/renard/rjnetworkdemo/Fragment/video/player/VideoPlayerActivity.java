...
import com.renard.playerview.danmuku.OnDanmakuListener;
import com.renard.playerview.media.IjkPlayerView;
import com.renard.playerview.utils.SoftInputUtils;
...
import com.renard.rjnetwork.utils.CommonConstant;
import com.renard.rjnetwork.widget.SimpleButton;
import com.renard.rjnetworkdemo.R;
import com.renard.rjnetworkdemo.engine.DanmakuConverter;
import com.renard.rjnetworkdemo.engine.DanmakuLoader;
import com.renard.rjnetworkdemo.engine.DanmakuParser;
import com.renard.rjnetworkdemo.engine.DownloaderWrapper;
import com.renard.rjnetworkdemo.injector.components.DaggerVideoPlayerComponent;
import com.renard.rjnetworkdemo.injector.modules.VideoPlayerModule;
import com.renard.rjnetworkdemo.utils.DialogHelper;
import com.renard.rjnetworkdemo.utils.SnackbarUtils;
import com.renard.rjnetworkdemo.utils.dialog.ShareBottomDialog;
...
import static com.renard.rjnetwork.utils.CommonConstant.VIDEO_DATA_KEY;
 ...
 * @author suyanan
 */
public class VideoPlayerActivity extends BaseActivity<VideoPresenter> implements VideoView  {
    ...
    protected void initViews() {
        ...
        mPlayerView.init()
                ...
                .setDanmakuListener(new OnDanmakuListener<DanmakuInfo>() {
                    ...
                    @Override
                    public void onDataObtain(DanmakuInfo data) {
                        Logger.w(data.toString());
                        data.setUserName("Long");
                        data.setVid(mVideoData.getVid());
                        mPresenter.addDanmaku(data);
                    }
        ...
        Glide.with(this).load(mVideoData.getCover()).apply(requestOptions).into(mPlayerView.mPlayerThumb);
    ...
    public void loadData(VideoInfo videoInfo) {
        ...
        mIvVideoCollect.setChecked(videoInfo.isCollect());
        mIvVideoDownload.setSelected(videoInfo.getDownloadStatus()!= DownloadStatus.NORMAL);
    }
